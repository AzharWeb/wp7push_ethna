...
require_once 'Mpnstest_Error.php';
require_once 'Mpnstest_ActionClass.php';
require_once 'Mpnstest_ActionForm.php';
require_once 'Mpnstest_ViewClass.php';

/**
 *  Mpnstest application Controller definition.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Mpnstest
 */
class Mpnstest_Controller extends Ethna_Controller
{
    /**#@+
     *  @access private
     */
    ...
    var $class = array(
        ...
        'form'          => 'Mpnstest_ActionForm',
        'i18n'          => 'Ethna_I18N',
        'logger'        => 'Ethna_Logger',
        'plugin'        => 'Ethna_Plugin',
        'session'       => 'Ethna_Session',
        'sql'           => 'Ethna_AppSQL',
        'view'          => 'Mpnstest_ViewClass',
        'renderer'      => 'Ethna_Renderer_Smarty',
        'url_handler'   => 'Mpnstest_UrlHandler',
    );
    ...
    var $plugin_search_appids = array(
         ...
         *  2. Mpnstest_Plugin_Foo_Bar
         *  3. Ethna_Plugin_Foo_Bar
         *
         *  'Common', 'Mpnstest', 'Ethna',
         */
        'Mpnstest', 'Ethna',
    );
